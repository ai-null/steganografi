...
public class Main extends javax.swing.JFrame {
   Steganografi model;
    ...
    private void initComponents() {
        ...
        tabMenu.setBackground(new java.awt.Color(153, 153, 153));

        pnlKompres.setBackground(new java.awt.Color(102, 102, 102));

        jPanel3.setBackground(new java.awt.Color(153, 153, 255));

        lblGambar.setText("Cover Image");

        lblTeks.setText("Hidden Text");
        ...
        lblGambar1.setText("Stego Image");
        ...
        lblNamFile.setText("Nama File Decode");
        ...
        tabMenu.addTab("Decode", pnlEkstrak);

        pnlBackground.add(tabMenu, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, -1, 430));

        jLabel1.setFont(new java.awt.Font("Showcard Gothic", 1, 24)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(0, 0, 0));
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Implementasi Steganografi");
...
//                    vig.Dekrip(cipher, key);
            ...
            try{
                ...
                if(stegan != ""){
                    if(model.encode(path,name,ext,stegan,text)){
                        JOptionPane.showMessageDialog(null, "Penyisipan pesan berhasil! \n"
    ...
    private void btnTeksActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTeksActionPerformed
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Pilih file pdf");
        }
